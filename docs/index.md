...
- **[Reading ROOT files](root.md)** - trees, split C++ objects and STL
  containers in pure Python, member by member or whole, streamed into PyTorch
  or TensorFlow a basket at a time.
...
reader are implemented and tested - 2607 tests, the great majority of which need no network, no KDC and no
